...
const courses = [
  {
    ...
    fee: "₹80,000 / Year",
    overview:
      "The BCA program provides students with a strong foundation in computer science, programming, database management, networking, and software development.",
    highlights: [
  ...
  },
  {
    ...
    fee: "₹60,000 / Year",
    overview:
      "The B.Com Regular program equips students with comprehensive knowledge in accounting, finance, taxation, business law, and economics.",
    highlights: [
  ...
  },
  {
    ...
    fee: "₹60,000 / Year",
    overview:
      "B.Com Professional is designed for students aspiring for CA, CS, and CMA. It includes exclusive coaching alongside regular degree curriculum.",
    highlights: [
  ...
  },
  {
    ...
    fee: "₹70,000 / Year",
    overview:
      "The BBA program develops managerial and entrepreneurial skills. The curriculum covers marketing, HR, finance, operations management, and strategic planning.",
    highlights: [
  ...
  },
  {
    ...
    overview:
      "Exclusive coaching for CA Foundation and Intermediate exams conducted alongside the regular B.Com program by experienced CA faculty.",
    highlights: [
  ...
  },
  {
    ...
    fee: "Included in B.Com Professional fee",
    overview:
      "Dedicated coaching for CS Foundation and Executive modules with focus on corporate laws, governance, and compliance.",
    highlights: [
            ...
            {courses.map((c, i) => (
              <ScrollReveal key={c.name} delay={i * 80}>
                ...
                >
                  {/* Hover gradient bg */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${c.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl`}
                  />
                  {/* Top accent line */}
              ...
              <Link to="/admissions">
                ...
                >
                  ...
                  <span className="relative flex items-center gap-2">
                    <GraduationCap className="w-5 h-5" /> Apply for Admission{" "}
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl">
          {selectedCourse && (
            <>
              <DialogHeader>
                <div
                  className={`flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-br ${selectedCourse.color} border border-border/30 mb-2`}
                >
              ...
              <div className="space-y-5">
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  {[
                    ...
                    <div
                      key={item.label}
                      className="flex items-start gap-3 bg-muted/30 rounded-xl p-3 border border-border/50 hover:bg-muted/50 transition-colors duration-200"
                    >
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-2">
                    {selectedCourse.highlights.map((h) => (
                      <div
                        key={h}
                        className="flex items-center gap-2.5 font-body text-sm text-muted-foreground p-2.5 rounded-xl hover:bg-muted/40 transition-colors duration-200 group"
                      >
                        <CheckCircle className="w-4 h-4 text-secondary shrink-0 group-hover:scale-110 transition-transform" />{" "}
                        {h}
                      </div>
                    ))}
                  </div>
