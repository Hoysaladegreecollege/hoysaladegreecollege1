...
const contactInfo = [
  {
    ...
    color: "from-blue-500/10 to-blue-500/3", iconBg: "bg-blue-500/10", iconColor: "text-blue-600",
  },
  {
    icon: Phone, label: "Phone Numbers",
    value: "7676272167 • 7975344252 • 8618181383 • 7892508243",
    link: "tel:7676272167",
    color: "from-emerald-500/10 to-emerald-500/3", iconBg: "bg-emerald-500/10", iconColor: "text-emerald-600",
  },
  {
    icon: Mail, label: "Email",
    value: "principal.hoysaladegreecollege@gmail.com",
    link: "mailto:principal.hoysaladegreecollege@gmail.com",
    color: "from-primary/10 to-primary/3", iconBg: "bg-primary/10", iconColor: "text-primary",
  },
  {
    icon: Clock, label: "Office Hours",
    value: "Mon – Sat: 9:00 AM – 5:00 PM",
    link: undefined,
    color: "from-secondary/12 to-secondary/3", iconBg: "bg-secondary/15", iconColor: "text-secondary-foreground",
  },
];
...
export default function Contact() {
  ...
  const inputClass = "w-full border border-border rounded-xl px-4 py-3 font-body text-sm bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all duration-300 placeholder:text-muted-foreground/40 hover:border-primary/25 hover:shadow-sm";
              ...
              <div className="space-y-3">
                {contactInfo.map((item, i) => (
                  <div key={item.label}
                    ...
                    <div className={`w-11 h-11 rounded-xl ${item.iconBg} flex items-center justify-center shrink-0 group-hover:scale-110 group-hover:rotate-3 transition-all duration-400 shadow-sm`}>
                ...
                {/* Quick dial chips */}
                <div className="pt-2">
                  <p className="font-body text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2.5">Quick Dial</p>
              ...
              <div className="premium-card p-6 sm:p-8 relative overflow-hidden">
                ...
                {submitted ? (
                  <div className="flex flex-col items-center justify-center h-72 animate-scale-bounce text-center">
                    ...
                    <p className="font-body text-sm text-muted-foreground max-w-xs">We'll get back to you soon. Thank you for reaching out!</p>
                    <div className="mt-5 flex gap-1">
                      {[0, 1, 2, 3, 4].map(i => (
                        <div key={i} className="w-2 h-2 rounded-full bg-secondary animate-bounce" style={{ animationDelay: `${i * 100}ms` }} />
                      ))}
                    </div>
                  </div>
                ) : (
