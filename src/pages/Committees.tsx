...
import { Globe, Briefcase, Monitor, Award, Users, Heart, Shield, BookOpen, Leaf, Scale, Sparkles, MessageSquare } from "lucide-react";
...
const committees = [
  ...
  { name: "NSS Unit", icon: Award, desc: "Community service, blood donation drives, and social awareness campaigns." },
  ...
  { name: "Student Counseling Cell", icon: MessageSquare, desc: "Professional counseling support for student well-being and mental health." },
