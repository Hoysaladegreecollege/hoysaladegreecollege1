...
import { UserCheck, UserX, Filter, ArrowLeft, Users, Eye, Phone, X, User, BookOpen, Calendar, MapPin } from "lucide-react";
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="pt-2 space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <a
                      href={selectedStudent.phone ? `tel:${selectedStudent.phone}` : "#"}
                    ...
                    <a
                      href={selectedStudent.parent_phone ? `tel:${selectedStudent.parent_phone}` : "#"}
                      className={`flex items-center justify-center gap-2 p-3 rounded-xl font-body text-sm font-semibold transition-all duration-200 ${
                  ...
                  {(!selectedStudent.phone && !selectedStudent.parent_phone) && (
                    <p className="font-body text-[11px] text-muted-foreground text-center">No phone numbers available</p>
                  )}
                </div>
              </div>
            </div>
